 ...
 * @param {string} opts.coin[='pot'] - The coin for this wallet (pot, bch).
 ...
 * @param {string} opts.coin[='pot'] - The expected coin for this wallet (pot, bch).
...
WalletService.prototype.savePreferences = function(opts, cb) {
  ...
  var preferences = [{
    ...
    name: 'unit',
    isValid: function(value) {
      return _.isString(value) && _.contains(['pot', 'bit'], value.toLowerCase());
    },
  }];
 ...
 * @param {Object} opts
 * @param {String} [opts.coin='pot'] (optional)
 ...
 * @param {Object} opts
 * @param {string} [opts.coin = 'pot'] - The coin to estimate fee levels from.
 ...
 * @param {Object} opts
 * @param {string} [opts.coin = 'pot'] - The coin for this transaction.
