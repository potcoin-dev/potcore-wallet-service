...
Defaults.BALANCE_CACHE_DIRECT_DURATION = 2.5;
Defaults.BALANCE_CACHE_DURATION = 2.5;

// Cache time for blockchain height (in seconds)
Defaults.BLOCKHEIGHT_CACHE_TIME = 10;
...
Defaults.RateLimit = {
  ...
  estimateFee: {
   windowMs: 60 * 10 *1000, // 10 min window
    ...
    max: 60, // start blocking after 200 request
